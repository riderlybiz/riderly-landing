...
export const ApplicationForm = () => {
    ...
    return (
        <ApplicationFormWrap id='application-form'>
            ...
            <ApplicationFormCardWrap>
                <ApplicationFormInputFlexWrap>
                    <InputText value={name} onChange={(value: string) => handleChangeValue(value, setName)}>이름
                        *</InputText>
                    <InputText value={telNumber} onChange={(value: string) => handleChangeValue(value, setTelNumber)}>연락처
                        *</InputText>
                </ApplicationFormInputFlexWrap>
                <InputText value={email} onChange={(value: string) => handleChangeValue(value, setEmail)}>이메일
                    *</InputText>
                <ApplicationFormCheckboxWrap>
            ...
            <ApplicationTitleWrap>
                ...
                <PreRegistrationItemDescription>
                    ...
                    필요한 특별한 유료 기능들을 무료로 체험해 수 있는 1개월 무료 이용권 지급
                </PreRegistrationItemDescription>
                <PreRegistrationItemTitle>
                    🏆 창립 멤버
                </PreRegistrationItemTitle>
